                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold prose-p:leading-relaxed prose-p:text-slate-600 dark:prose-p:text-white/70">
                        ...
                        <div className="mb-12">
                            ...
                            <ul className="list-disc ps-6 space-y-3 mt-4 text-slate-600 dark:text-white/70 marker:text-slate-400 dark:marker:text-white/30">
                                ...
                                <li dangerouslySetInnerHTML={{ __html: t.raw("section2_list3") as string }} />
                            </ul>
                        ...
                        <div className="mb-12">
                            ...
                            <p dangerouslySetInnerHTML={{ __html: t.raw("section3_desc1") as string }} />
                            <p className="mt-4">
                                {t("section3_desc2")}
                            </p>
                        </div>
                        ...
                        <div className="mb-8">
                            ...
                            <p dangerouslySetInnerHTML={{ __html: t.raw("section4_desc") as string }} />
                        </div>
