                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold prose-p:leading-relaxed prose-p:text-slate-600 dark:prose-p:text-white/70">
                        ...
                        <div className="mb-12">
                            ...
                            <ul className="list-disc ps-6 space-y-3 mt-4 text-slate-600 dark:text-white/70 marker:text-slate-400 dark:marker:text-white/30">
                                ...
                                <li dangerouslySetInnerHTML={{ __html: t.raw("section1_list3") as string }} />
                            </ul>
                        </div>
                        ...
                        <div className="mb-12">
                            ...
                            <ul className="list-disc ps-6 space-y-3 mt-4 text-slate-600 dark:text-white/70 marker:text-slate-400 dark:marker:text-white/30">
                                ...
                                <li>{t("section2_list3")}</li>
                                <li>{t("section2_list4")}</li>
                            </ul>
                        ...
                        <div className="mb-12">
                            ...
                            <p dangerouslySetInnerHTML={{ __html: t.raw("section3_intro1") as string }} />
                            <p className="mt-4">
                                {t("section3_intro2")}
                            </p>
                        </div>
                        ...
                        <div className="mb-8">
                            ...
                            <ul className="list-disc ps-6 space-y-3 mt-4 text-slate-600 dark:text-white/70 marker:text-slate-400 dark:marker:text-white/30">
                                <li>{t("section4_list1")}</li>
                                <li>{t("section4_list2")}</li>
                                <li>{t("section4_list3")}</li>
                            </ul>
                        </div>
